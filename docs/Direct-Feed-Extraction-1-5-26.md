...
Direct feed extraction should run 45 minutes AFTER Google News ingest starts, allowing Google News processing to begin without blocking:

```
EACH CYCLE:
═══════════════════════════════════════════════════════
0:00     Google News Ingest starts
+1:30    AI Scoring starts
+2:15    DIRECT FEED INGEST (45 min after scoring)
+2:45    Pre-Filter starts
```

### Recommended Cron Times

| Cycle | Google News Start | Direct Feed Start (UTC) |
|-------|-------------------|-------------------------|
| Night | 2:00 AM ET (7:00 UTC) | 3:45 AM ET (8:45 UTC) |
| Morning | 9:30 AM ET (14:30 UTC) | 11:15 AM ET (16:15 UTC) |
| EOD | 5:00 PM ET (22:00 UTC) | 6:45 PM ET (23:45 UTC) |
