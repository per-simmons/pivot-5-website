...
export const stepConfigs: StepConfig[] = [
  ...
  },
  {
    id: 4,
    name: "Compile & Send",
    description: "Compile HTML email, send via Mautic, or test via Gmail",
    schedule: "10:00 PM ET (compile) / 5:00 AM ET (send)",
    icon: "code",
    prompts: [
      { id: "summary_generator", name: "Summary Generator", model: "claude-sonnet-4-5-20250929", temperature: 0.5, description: "Generate 15 and 20-word newsletter summaries" },
    ],
    dataTable: {
  ...
  },
  {
    id: 5,
    name: "Archive",
    description: "View archived newsletter issues with send metrics",
    schedule: "Auto-archived after send",
    icon: "archive",
    prompts: [],
    dataTable: {
      name: "Newsletter Issues Archive",
      tableId: "tblB7j5qGcTxyXmfa",
      baseId: "appglKSJZxmA9iHpl",
    },
  },
];
